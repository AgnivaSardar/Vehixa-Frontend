      ...
      <div ref={ref} className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            AutoVitals AI combines cutting-edge machine learning with automotive telemetry to deliver real-time vehicle health intelligence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {cards.map((card, i) => (
            ...
            >
              ...
              <h3 className="font-[Orbitron] text-xl font-semibold text-white mb-3 group-hover:text-[#00ff88] transition-colors">
                {card.title}
              </h3>
